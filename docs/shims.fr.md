<!-- INSTANTANE FIGE : le generateur (tools/gen_shim_list.py) produit desormais -->
<!-- la version anglaise (shims.md) et n'est plus maintenu en francais. Cette -->
<!-- page peut donc diverger des sources avec le temps. -->
